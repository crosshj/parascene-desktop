...
export function AddAssetIntentPanel({
  ...
  const canLibraryGenerate =
    !providerOnly && addAssetIntentAllowsLibraryGeneration(intent);
  ...
  if (canLibraryGenerate) {
    return (
      <ReplicateTextToImageFormLayout idPrefix="add-asset-t2i">
        {({ fields, footer }) => (
          <div
          ...
          <section className="add-asset-generate-section">
            <div className="add-asset-generate-callout">
              <p className="muted" style={{ margin: 0 }}>
                ...
                video fill under Parascene to place a blank clip and generate.
              </p>
            </div>
          </section>
        ) : null}
